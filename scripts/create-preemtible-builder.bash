...
gcloud compute instances create adhoc-builder --project=telvanni-platform --zone=us-central1-a \
--machine-type=e2-standard-4 --network-interface=network-tier=PREMIUM,subnet=subnet-01 --no-restart-on-failure \
