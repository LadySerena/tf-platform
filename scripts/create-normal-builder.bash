...
gcloud compute instances create adhoc-normal-builder --project=telvanni-platform --zone=us-central1-a \
--machine-type=e2-standard-2 --network-interface=network-tier=PREMIUM,subnet=subnet-01 \
